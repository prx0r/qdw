...
from qdw.core.core import hash_object,utc_now
from .runner import VerificationRunner

class BuildCertificateBuilder:
    def __init__(self,runner:VerificationRunner):self.runner=runner
    ...
    def build(self,*,task_id:str,required_commands:list[list[str]],acceptance_spec_hash:str,
        ...
        failed=[list(argv) for argv,r in by_argv.items() if r.exit_code!=0 and list(argv) in required_commands]
